...
public class Google_new_user_sign_up extends Set {
	...
	public void user_click_on_sign_in_with_google_button() throws InterruptedException  {
	    ...
	    WebElement next_2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div/div[2]/div/div[2]/div/div[1]/div/div/button/div[2]")));
	    Thread.sleep(2000);
	    next_2.click();
	}
