...
public class Google_new_user_sign_up extends Set {
	...
	public void user_click_on_sign_in_with_google_button() throws InterruptedException  {
	    ...
	    Thread.sleep(2000);
	    WebElement next_1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("#identifierNext > span:nth-child(3) > span:nth-child(1)")));
	    Thread.sleep(2000);
	    next_1.click();
	    Thread.sleep(2000);
	    ...
	    WebElement next_2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("#passwordNext > span:nth-child(3)")));
	    Thread.sleep(2000);
	    next_2.click();
	}
